...
namespace pluginTcl.Tcl
{
    public class WordScanner : IDisposable
    {
        ...
        public Tcl.ParsedDocument RootParsedDocument { get; protected set; }
        ...
        private bool systemTcl;
        public bool SystemTcl
        {
            get { return systemTcl; }
        }
        ...
        {
            WordScanner ret = new WordScanner(wordPointer.Document, RootParsedDocument,systemTcl);
...
//            sw2.Stop();
        ...
        //    // search in same folder with original Tcl file
        ...
        //    else
        //    {
        //        item = Data.TclHeaderFile.CreateInstance(relativeFilePath, id, wordPointer.ParsedDocument.Project);
        //    }
        //    codeEditor.Data.ITextFile textFile = item as codeEditor.Data.ITextFile;
        //    if(textFile == null ||! (textFile is Data.TclHeaderFile))
        //    {
        //        wordPointer.AddError("illegal filetype");
        //        return;
        //    }

        //    Data.TclHeaderFile vhFile = textFile as Data.TclHeaderFile;
